...
def predict_extraversion(row, extraversion_model):
...
def predict_openness(row, openness_model):
...
def get_user_traits(features: dict):
    ...
    for index, row in df.iterrows():
        ...
        try:
            e_pred = predict_extraversion(row_features, extraversion_model)
            o_pred = predict_openness(row_features, openness_model)
